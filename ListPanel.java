...
import org.neeraj.algorithms.searching.SearchGUI.Algorithm;
...
public class ListPanel extends JPanel
{
    ...
    protected class SearchListener implements ActionListener {
		public void actionPerformed(ActionEvent ev)
		{
			ListPanel listPanel=SearchGUI.listPanel;
			Algorithm algorithm = Algorithm.LINEAR;
			Value str=new Value(Double.parseDouble(text.getText()));
			Comparable text=str;
		    ...
		    if (algorithm == Algorithm.LINEAR){
			    ...
			    int loc=search.search(array,text);
			    if(loc>-1) {
				...
				try {
					    Search Search = (Search) algorithm.factory.newInstance();
				    ...
				    System.err.println("Couldn't Instantiate a Search");
				}
